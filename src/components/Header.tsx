...
function Header() {
  ...
  return (
    <Container tag='header' className=' bg-dark text-white fixed translate-x-[-50%] left-[50%] shadow-lg flex justify-between items-center text-sm lg:text-base xl:text-lg py-3 lg:py-5 z-10' >
      ...
      <ul className={`flex flex-col justify-center transition-transform duration-500 items-center gap-5 fixed top-[100%] left-0 w-full h-screen text-2xl lg:static lg:flex-row lg:text-base lg:gap-5 lg:h-fit lg:w-fit  ${!showMenu && 'translate-x-[100%]'} lg:translate-x-0`} >
        {
